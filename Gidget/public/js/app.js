...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    //reset login status
    userService.logout(); // get return url from route params or default to '/
  ...
  methods: {
    handleSubmit: function handleSubmit(e) {
      ...
      var email = this.email,
          password = this.password; //stop if form is invalid
      ...
      userService.login(email, password).then(function (user) {
        return router.push(_this.returnUrl);
      }, function (error) {
        _this.error = error;
        _this.loading = false;
      });
            ...
            _vm._l(_vm.menuItems, function(item) {
              return _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("v-list-tile-content", [_vm._v(" " + _vm._s(item.title))])
                ],
                1
              )
            }),
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [_c("p", [_vm._v("This is a user's home page")])]
          )
        ],
        1
      )
    ...
    [
      _c(
        ...
        [
          _c(
            "v-flex",
            { staticClass: "text-md-center", attrs: { md12: "", "mt-5": "" } },
            [_c("h1", [_vm._v("Welcome to Gidget")])]
          ),
          _vm._v(" "),
          _c(
            "v-flex",
            { attrs: { md12: "", sm6: "", "offset-sm3": "", "mt-3": "" } },
            [
              _c("blockquote", { staticClass: "blockquote text-md-center" }, [
                _vm._v("\n                This is a SPA mock of Gidget "),
                _c("br"),
                _vm._v(
          ...
          _c(
            "v-flex",
            {
              ...
              attrs: { xs12: "", sm6: "", md3: "", "offset-sm3": "", mt5: "" }
            },
            [
              _c("v-btn", { attrs: { color: "primary", to: "/signup" } }, [
                _vm._v("Sign-Up")
              ]),
              _vm._v(" "),
              _c("v-btn", { attrs: { to: "/signin" } }, [_vm._v("Sign In")])
            ],
            1
          )
        ],
...
/* harmony import */ var _components_Landing_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Landing.vue */ "./resources/js/components/Landing.vue");
/* harmony import */ var _components_Signin_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Signin.vue */ "./resources/js/components/Signin.vue");
/* harmony import */ var _components_Signup_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Signup.vue */ "./resources/js/components/Signup.vue");
